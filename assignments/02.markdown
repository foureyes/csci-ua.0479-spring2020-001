...
* using the previous results, in the next 3 cells, apply one of following filters on chocolate and almond / peanut in each cell
	1. chocolate and almond / peanut that have win percentage is < than 50
	2. chocolate and almond / peanut candies whose name starts with "Reese" __YOU MUST USE A LAMBDA FOR THIS__
	3. chocolate and almond / peanut  candies whose name is less than 10 characters long __YOU MUST USE A LAMBDA FOR THIS__
